...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        saving.setBackground(Color.cyan);
        ...
        fixed.setBackground(Color.cyan);
        ...
        recurring.setBackground(Color.cyan);
        ...
        carddetail.setBackground(Color.cyan);
        ...
        pindetail.setBackground(Color.cyan);
        ...
        pnumber.setBackground(Color.cyan);
        ...
        services.setBackground(Color.cyan);
